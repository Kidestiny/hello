<template>
	<view class="content">
		...
		<view class="pageForm">
			<view class="formItem">
				<view class="textWord"><text>请输入权重等级(1~16)</text></view>
		...
		<view class="myButtonOut">
			...
			<view class="myButtonIn">
				<u-button @click="luck(10)">抽10次(必出稀有)</u-button>
			</view>
		</view>
		<ad unit-id="adunit-c2c9c48c45ec5db4" ad-type="video" ad-theme="white"></ad>
		<view class="myButton">
			<u-button type="primary" @click="seeAllGenerals" :ripple="true">查看本次抽到的所有皮肤</u-button>
		</view>
		<view v-if="this.onceGiftArray.length!=0">
			<view>黑色是普通皮肤，紫色是精品，红色是史诗</view>
		...
		<view class="myButton">
			<u-button type="primary" @click="onSubmit100" :ripple="true">拉满(100个甲)</u-button>
		</view>
...
export default {
	...
	onLoad() {
		uni.request({
			url:"https://7367-sgs-5gwi2f826ca612c8-1304922515.tcb.qcloud.la/skins.json?sign=5b63e1d0fd349b85499327d80426ee92&t=1708860069",
			method: "GET",
			success: (res) => {
		...
		if (wx.createRewardedVideoAd) {
		  this.videoAd = wx.createRewardedVideoAd({
		    adUnitId: 'adunit-04d49af413175d6a'
		  })
		  this.videoAd.onLoad(() => {})
